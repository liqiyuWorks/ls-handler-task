...
const processTimeWeightedData = (rawData, selectedProduct) => {
    ...
    sortedDates.forEach(dateKey => {
        ...
        if (uniqueContracts.length >= 2) {
            ...
            const synthClose = m1.close * w1 + m2.close * w2;
            const synthHigh = m1.high * w1 + m2.high * w2;
            const synthLow = m1.low * w1 + m2.low * w2;
            
            dailyData.push({
                date: m1.date, // Date Object
                dateStr: dateKey,
                close: synthClose,
                high: synthHigh,
                low: synthLow,
                spread: m1.close - m2.close,
                weight_m2: w2,
                M1_Price: m1.close,
                M2_Price: m2.close,
