...
from tasks.axsmarine.subtasks.sync_ships_fuel_from_axs import SyncShipsFuelFromAxs, SyncSearchVesselsFuelFromAxs, SyncNioVesselsFuelFromAxs
...
def get_task_dic():
    task_dict = {
        ...
        "sync_search_vessels_fuel_from_axs": (lambda: SyncSearchVesselsFuelFromAxs(), 'Axsmarine=> 从搜索历史船舶燃油价格到mgo'),
