...
class CleanBoschCaiyunPng:
    def run(self):
        ...
        INPUT_PATH = os.getenv('INPUT_PATH',  "/Users/jiufangkeji/Documents/JiufangCodes/ls-handler-task/input/test/")
        last_mon = (datetime.datetime.now() + datetime.timedelta(days=-DAY))  .strftime("%Y%m%d")
