...
def get_task_dic():
    task_dict = {
        ...
        "update_mmsi": (lambda: UpdateMmsi(), 'Navgreen => 2.1、检查并更新干散货和杂货船的MMSI（判断是否已更新为最新的）'),
        "update_year_of_build": (lambda: UpdateYearOfBuild(), 'Navgreen => 2.2、更新散货船和杂货船船舶记录（丰富global_vessels的船舶详情档案）'),
