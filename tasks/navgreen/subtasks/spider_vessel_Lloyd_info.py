    ...
    def run(self):
        ...
        try:
            ...
            imo_list_after_deduplication = [
                imo for imo in imo_list if imo not in existing_lrno_list]
            print(len(imo_list), len(existing_lrno_list),
                  len(imo_list_after_deduplication))
            ...
            for batch in imo_batches:
                ...
                for item in res:
                    print(item.get("fmShipDTO").get("lrno"))
