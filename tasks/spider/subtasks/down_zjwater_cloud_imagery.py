...
class DownZjwaterCloudImagery(BaseModel):
    # cloud_imagery = "https://img.istrongcloud.com/data/images/cloud/zjwater_transparent.json?v=1693879668726"
    cloud_imagery_url = "https://img.istrongcloud.com/data/images/cloud/zjwater_transparent.json?v={}"

    def __init__(self) -> None:
        config = {"rds": True, "handle_db": "rds"}
        super(DownZjwaterCloudImagery, self).__init__(config)
        self._file_path = os.getenv(
            "FILE_PATH", "/Users/jiufangkeji/Documents/JiufangCodes/ls-handler-task")
        self.step = int(os.getenv("STEP", 5))
        self._rds_key = "wztfw_cloud_newest_reporttime"
    ...
    def run(self):
        ...
        req_url = self.cloud_imagery_url.format(timestamp)
        ...
        for rar in radar_list[-self.step:]:
            ...
            obs_key = f"cloud_imagery/{year}/{mon}/{day}/" + reporttime_name
