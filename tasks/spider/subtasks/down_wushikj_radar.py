...
class DownWushikjRadar():
    # radar_url = "https://typhoon.wushikj.com/images/radar/mingle/zytyphoon_transparent/202309/01/202309011430.png"
    radar_url = "https://typhoon.wushikj.com/images/radar/mingle/zytyphoon_transparent/{}/{}/{}.png"
    ...
    def run(self):
        ...
        url = self.radar_url.format(req_month, req_day, recent_time)
        ...
        if content_length < 1000:
            ...
            obs_key = f"radar/{year}/{mon}/{day}/" + recent_time + ".png"
