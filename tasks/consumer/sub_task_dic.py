...
from tasks.consumer.subtasks.convert_nc2json_obs import ConvertGFSWindnc2jsonObs, ConvertEra5Windnc2jsonObs
...
def get_task_dic():
    task_dict = {
        ...
        "convert_era5_wind_nc2json_obs": (lambda: ConvertEra5Windnc2jsonObs(), '消费者=> 转换ERA5的nc成json, 并上传到obs'),
